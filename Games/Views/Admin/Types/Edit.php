...
    <div class="box-body">
		...
		<form action='<?=site_url('admin/games/types/'.$type->id);?>' method='post'>
		...
		<div class="control-group">
		    ...
		    <input class="form-control" id='title' type="text" name="title" value="<?=Input::old('title', $type->title);?>" />
		</div>
